...
#define ETH_EUSCI_MODULE 	EUSCI_B0_BASE
#define ETH_EUSCI_REC_INT		EUSCI_B_SPI_RECEIVE_INTERRUPT
#define ETH_EUSCI_TRAN_INT		EUSCI_B_SPI_TRANSMIT_INTERRUPT
#define ETH_INT_ENABLE 		INT_EUSCIB0
//SCLK P1.5
#define ETH_SCLK_PIN 		GPIO_PIN5
#define ETH_SCLK_PORT 		GPIO_PORT_P1

//MOSI P1.6
#define ETH_MOSI_PIN 		GPIO_PIN6
#define ETH_MOSI_PORT 		GPIO_PORT_P1

//MISO P1.7
#define ETH_MISO_PIN 		GPIO_PIN7
#define ETH_MISO_PORT 		GPIO_PORT_P1
